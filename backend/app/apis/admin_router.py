...
from app.apis.v1.admin.drug_sync import router as admin_drug_sync_router
...
admin_router.include_router(admin_drug_sync_router, prefix="/drug-sync", tags=["관리자 약품동기화"])
